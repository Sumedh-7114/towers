...
function setup(){
 ...
 box22= new GreenBox (500,130,20,30);
 ...
 box28= new BlueBox  (560,105,20,30);
 box29= new RedBox   (560,105,20,30);
 box30= new YellowBox(560,105,20,30);
 box31= new GreenBox (560,105,20,30);
 box32= new RedBox   (560,105,20,30);

 box33= new YellowBox(560,250,20,30);
 box34= new BlueBox(560,250,20,30);
 box35= new RedBox(560,250,20,30);
 box36= new GreenBox(560,250,20,30);
 
 box37= new YellowBox(560,250,20,30);
 box38= new BlueBox(560,250,20,30);
 box39= new GreenBox(560,250,20,30);
